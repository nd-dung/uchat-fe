...
export const ListChatbotsResponse = zod
  .object({
    success: zod.boolean(),
...
export const CreateChatbotBody = zod.object({
  facility_id: zod.number(),
  name: zod.string(),
  display_name: zod.looseObject({}).optional(),
  description: zod.looseObject({}).optional(),
  status: zod.enum(["active", "inactive", "draft"]).optional(),
})

export const CreateChatbotResponse = zod
  .object({
    success: zod.boolean(),
    status_code: zod.number(),
    message: zod.string(),
...
export const GetChatbotResponse = zod
  .object({
    success: zod.boolean(),
    status_code: zod.number(),
    message: zod.string(),
...
export const UpdateChatbotResponse = zod
  .object({
    success: zod.boolean(),
    status_code: zod.number(),
    message: zod.string(),
...
export const DeleteChatbotResponse = zod
  .object({
    success: zod.boolean(),
    status_code: zod.number(),
    message: zod.string(),
...
export const GetChatbotUiSettingParams = zod.object({
  id: zod.number(),
})

export const GetChatbotUiSettingResponse = zod
  .object({
    success: zod.boolean(),
    status_code: zod.number(),
    message: zod.string(),
...
export const UpdateChatbotUiSettingParams = zod.object({
  id: zod.number(),
})

export const UpdateChatbotUiSettingBody = zod.object({
  launcher: zod.looseObject({}).optional(),
  chat_window: zod.looseObject({}).optional(),
  header: zod.looseObject({}).optional(),
  message: zod.looseObject({}).optional(),
  typography: zod.looseObject({}).optional(),
  input: zod.looseObject({}).optional(),
  welcome: zod.looseObject({}).optional(),
  animation: zod.looseObject({}).optional(),
  footer: zod.looseObject({}).optional(),
  primary_color: zod.looseObject({}).optional().describe("Legacy flat field."),
  background_color: zod
    .looseObject({})
    .optional()
    .describe("Legacy flat field."),
  avatar_url: zod.looseObject({}).optional().describe("Legacy flat field."),
  logo_url: zod.looseObject({}).optional().describe("Legacy flat field."),
  launcher_icon_url: zod
    .looseObject({})
    .optional()
    .describe("Legacy flat field."),
})

export const UpdateChatbotUiSettingResponse = zod
  .object({
    success: zod.boolean(),
    status_code: zod.number(),
    message: zod.string(),
