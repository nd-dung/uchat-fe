...
export const ListChatbotsQueryParams = zod.object({
  ...
  "sort_by": zod.enum(['created_at', 'updated_at', 'name', 'display_name', 'status']).optional(),
...
export const ListChatbotsResponse = zod.object({
  "success": zod.boolean(),
...
export const CreateChatbotResponse = zod.object({
  "success": zod.boolean(),
  "status_code": zod.number(),
  "message": zod.string(),
  "meta_data": zod.object({
...
export const DeleteChatbotResponse = zod.object({
  "success": zod.boolean(),
  "status_code": zod.number(),
  "message": zod.string(),
  "meta_data": zod.object({
...
export const GetChatbotUiSettingResponse = zod.object({
  "success": zod.boolean(),
  "status_code": zod.number(),
  "message": zod.string(),
  "meta_data": zod.object({
...
export const UpdateChatbotUiSettingBody = zod.object({
  "launcher": zod.looseObject({

}).optional(),
  "chat_window": zod.looseObject({

}).optional(),
  "header": zod.looseObject({

}).optional(),
  "message": zod.looseObject({

}).optional(),
  "typography": zod.looseObject({

}).optional(),
  "input": zod.looseObject({

}).optional(),
  "welcome": zod.looseObject({

}).optional(),
  "animation": zod.looseObject({

}).optional(),
  "footer": zod.looseObject({

}).optional(),
  "primary_color": zod.looseObject({

}).optional().describe('Legacy flat field.'),
  "background_color": zod.looseObject({

}).optional().describe('Legacy flat field.'),
  "avatar_url": zod.looseObject({

}).optional().describe('Legacy flat field.'),
  "logo_url": zod.looseObject({

}).optional().describe('Legacy flat field.'),
  "launcher_icon_url": zod.looseObject({

}).optional().describe('Legacy flat field.')
})

export const UpdateChatbotUiSettingResponse = zod.object({
  "success": zod.boolean(),
  "status_code": zod.number(),
  "message": zod.string(),
  "meta_data": zod.object({
...
export const GetChatbotEmbedSettingResponse = zod.object({
  "success": zod.boolean(),
  "status_code": zod.number(),
  "message": zod.string(),
  "meta_data": zod.object({
...
export const UpdateChatbotEmbedSettingResponse = zod.object({
  "success": zod.boolean(),
  "status_code": zod.number(),
  "message": zod.string(),
  "meta_data": zod.object({
...
export const RotateChatbotEmbedPublicKeyResponse = zod.object({
  "success": zod.boolean(),
  "status_code": zod.number(),
  "message": zod.string(),
  "meta_data": zod.object({
